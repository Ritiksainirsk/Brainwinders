...
const CareerGuidanceBenefits = () => {
  return (
    <div className=" mx-auto px-6 ">
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 heading-font">
      ...
      <ul className="list-disc list-inside space-y-2 text-[16px] md:text-[20px]">
        <li>
...
const WhyBrainwonders = () => {
  return (
    <div className=" mx-auto py-12 px-6 text-" style={{textAlign:"justify"}}>
      <h2 className="text-3xl md:text-4xl font-bold mb-8 heading-font text-center">
      ...
      <p className="mb-6 text-[16px] md:text-[20px]">
...
const ConsultationBooking = () => {
  return (
    <div className=" mx-auto py-12 px-12 bg-gray-100 rounded-lg shadow-lg">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="flex-1 text-center md:text-left mb-6 md:mb-0">
          <h3 className="text-2xl font-bold mb-2">
            Book a 30-min Consultation With Our Expert
          </h3>
          <p className="text-black md:text-[20px]">
            Our expert career advisors will assess your current standing and guide you towards the next steps, 
            <br />
            empowering you to plan your career strategically and turn your dreams and aspirations into reality.
          </p>
        </div>
