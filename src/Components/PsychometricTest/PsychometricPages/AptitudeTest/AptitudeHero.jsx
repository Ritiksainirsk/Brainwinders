...
export default function AptitudeHero() {
  return (
    <div>
      <div className="bg-[#E3F2FB] px-2 lg:px-28 py-8 rounded-lg flex flex-col md:flex-row items-center justify-around ">
        {/* Left Section */}
        <div className=" text-center md:text-left">
          <h1 className="text-3xl md:text-4xl 2xl:text-5xl md:flex md:flex-col font-bold text-gray-800 leading-tight mb-2 md:mb-9">
            Let Your Aptitude Soar!
            <span className="text-[#043E56]">
              Test preparation that makes a difference
            </span>
          </h1>
          <p className="mt-4 text-black text-lg md:text-[2xl] 2xl:text-3xl md:flex md:flex-col">
