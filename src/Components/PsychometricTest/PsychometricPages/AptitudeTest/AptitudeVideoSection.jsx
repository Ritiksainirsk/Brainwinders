...
export default function AptitudeVideoSection() {
  return (
    <div>
      <div className="mx-auto py-2 px-5 lg:px-1">
        <div className="my-8">
          {/* Section Title */}
          ...
          <p className="text-center text-black text-xl md:text-[25px] font-bold mb-8">It basically refers to one’s ability to do certain kinds of work</p>
        ...
        <div className="flex flex-col lg:flex-row gap-5 md:gap-16">
          ...
          {/* right Text Section */}
          <div className=" lg:w-[55%] px-7 md:px-0">
            <p className="text-[20px] ml-[-32px]">Key Takeaways</p>

            <ul className=" list-disc space-y-6">
              <li className="text-[15px] md:text-[20px] text-black leading-relaxed">
