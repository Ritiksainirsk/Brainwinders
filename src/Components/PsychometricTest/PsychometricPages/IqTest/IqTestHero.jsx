    ...
    <div>
      <div className="bg-[#E3F2FB] p-8 rounded-lg flex flex-col md:flex-row items-center justify-around">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h1 className="text-3xl md:text-5xl 2xl:text-6xl font-bold text-gray-800 leading-tight md:mb-9">
            Have you wondered
            <br />
          ...
          <p className="mt-4 text-black text-lg md:text-[2xl] 2xl:text-3xl md:flex md:flex-col">
            ...
            <span>accurate iq score. Take our fast IQ test and find out</span>
            <span>just how smart you are. reach their highest potential.</span>
          </p>
