...
const InformationSection = () => {
  return (
    <div className="flex flex-col md:flex-row">
      <div className="bg-blue-100 p-8 flex-1">
        <h2 className="text-2xl font-bold mb-4 text-center">DERMATOGLYPHICS MEANING</h2>
        <p>
      ...
      <div className="bg-orange-100 p-8 flex-1">
        <h2 className="text-2xl font-bold mb-4 text-center">WHAT IS MULTIPLE INTELLIGENCE TEST?</h2>
        <p>
