...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Send a POST request to the backend API with the payload
      ...
      <div className="flex flex-col items-center justify-center p-8 bg-white md:shadow-2xl rounded-xl w-full max-w-sm md:border-2">
        ...
        <div className="flex flex-col items-center justify-center gap-2 mt-6">
          <span className="text-sm text-center text-gray-500 max-w-xs leading-snug">
            Sign Up to your account to continue enjoying our services.
          </span>
        </div>
            ...
            <div className="relative mt-1">
              ...
              >
                <path
                  ...
                  strokeWidth="1.5"
                  d="M5.121 15.121A3.003 3.003 0 014 13V9a3 3 0 016 0v4c0 .83-.336 1.58-.879 2.121A3.003 3.003 0 019 17H7a3.003 3.003 0 01-1.879-.879z"
                />
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="1.5"
                  d="M15 7h-1V6a3 3 0 00-6 0v1h-1a4 4 0 00-4 4v2a4 4 0 004 4h6a4 4 0 004-4v-2a4 4 0 00-4-4z"
                />
              </svg>
              <input
                type="text"
